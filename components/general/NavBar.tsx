  ...
  return (
    ...
    >
      <div className='w-[70%] flex justify-between items-center lg:w-[100%]'>
        ...
        <div className="flex-initial w-[full] md:w-[auto] md:mr-[0px] ml-[50px] justify-between 
        md:justify-start md:flex-col text-xl relative font-sans z-99">
          ...
          ${isOpen && 'bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40'}
           ${isOpen && 'w-[200px]'} ${isOpen && 'min-h-[100vh]'} ${isOpen && 'justify-between'} pr-[20px] 
           absolute right-[-30px] top-[-40px] z-[99]`}>
            ...
            <div className='absolute top-[120px]'>
              {isOpen && NavBarConfig.map((e: any, i: any) => (
                <Link key={i} href={e.link}>
                  <div className="text-[#0F3460] rounded rounded-[16px] py-[4px] px-[20px] my-8 mx-8 border-2 
                  border-[#0F3460] hover:border-[white] cursor-pointer"
                    onClick={
                      () => { setOpen(false) }
                    }
                  >
